...
<div class="card-register">
    <h3 class="text-center mb-4 text-warning fw-bold">Daftar Akun User</h3>
    ...
    <div class="text-center mt-3">
        <small>Sudah punya akun? <a href="login_user.php" class="text-decoration-none fw-bold text-warning">Login disini</a></small>
        <div class="mt-2">
